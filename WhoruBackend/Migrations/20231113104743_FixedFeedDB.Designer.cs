...
namespace WhoruBackend.Migrations
{
    ...
    [Migration("20231113104743_FixedFeedDB")]
    partial class FixedFeedDB
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WhoruBackend.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 11, 13, 10, 47, 43, 666, DateTimeKind.Utc).AddTicks(566),
                            RoleName = "Admin",
                            UpdatedDate = new DateTime(2023, 11, 13, 10, 47, 43, 666, DateTimeKind.Utc).AddTicks(571)
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 11, 13, 10, 47, 43, 666, DateTimeKind.Utc).AddTicks(572),
                            RoleName = "User",
                            UpdatedDate = new DateTime(2023, 11, 13, 10, 47, 43, 666, DateTimeKind.Utc).AddTicks(572)
                        });
                });
            ...
            modelBuilder.Entity("WhoruBackend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ActiveCode = "412002",
                            CreatedDate = new DateTime(2023, 11, 13, 10, 47, 43, 666, DateTimeKind.Utc).AddTicks(630),
                            Email = "nmc0401@gmail.com",
                            IsDisabled = false,
                            Password = "AQAQJwAAVJVTPUzhCp0FCE4KdeMBBlzXL0PGNZvIoKrvrFTM35eRZBA30ULuUKf5AUM8J/Ry",
                            Phone = "0769395658",
                            RoleId = 1,
                            UpdatedDate = new DateTime(2023, 11, 13, 10, 47, 43, 666, DateTimeKind.Utc).AddTicks(631),
                            UserName = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            ActiveCode = "412222",
                            CreatedDate = new DateTime(2023, 11, 13, 10, 47, 43, 675, DateTimeKind.Utc).AddTicks(7968),
                            Email = "20110455@gmail.com",
                            IsDisabled = false,
                            Password = "AQAQJwAAP7WKD0qbAJiaQXWIE5ifiKeqnxVD3FrRGGj6TR+zAOfRcfpgRtLGj+COWIN6J/6v",
                            Phone = "0769395658",
                            RoleId = 1,
                            UpdatedDate = new DateTime(2023, 11, 13, 10, 47, 43, 675, DateTimeKind.Utc).AddTicks(7971),
                            UserName = "admin_2"
                        });
                });
