...
namespace WhoruBackend.Migrations
{
    ...
    [Migration("20231022161514_UpdateRoleFK")]
    partial class UpdateRoleFK
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WhoruBackend.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 10, 22, 16, 15, 13, 708, DateTimeKind.Utc).AddTicks(7799),
                            RoleName = "Admin",
                            UpdatedDate = new DateTime(2023, 10, 22, 16, 15, 13, 708, DateTimeKind.Utc).AddTicks(7804)
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 10, 22, 16, 15, 13, 708, DateTimeKind.Utc).AddTicks(7807),
                            RoleName = "User",
                            UpdatedDate = new DateTime(2023, 10, 22, 16, 15, 13, 708, DateTimeKind.Utc).AddTicks(7808)
                        });
                });
            ...
            modelBuilder.Entity("WhoruBackend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 10, 22, 16, 15, 13, 708, DateTimeKind.Utc).AddTicks(8122),
                            Email = "nmc0401@gmail.com",
                            Password = "AQAQJwAApC4/tW0O5FPLe2k+7KL5rCXKiILmrI63g+CQOKdUtByk/HTL9QfwkOe2fMQhVhhr",
                            Phone = "0769395658",
                            RoleId = 1,
                            UpdatedDate = new DateTime(2023, 10, 22, 16, 15, 13, 708, DateTimeKind.Utc).AddTicks(8123),
                            UserName = "Admin",
                            isDisabled = false
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 10, 22, 16, 15, 13, 724, DateTimeKind.Utc).AddTicks(7608),
                            Email = "20110455@gmail.com",
                            Password = "AQAQJwAA/OZzZ5SQ2U+Tu1zYbhE7t8Q6NypkDMqXlYK6WWIcdCtHtbma3450fLWouY2GCMy/",
                            Phone = "0769395658",
                            RoleId = 1,
                            UpdatedDate = new DateTime(2023, 10, 22, 16, 15, 13, 724, DateTimeKind.Utc).AddTicks(7612),
                            UserName = "admin_2",
                            isDisabled = false
                        });
                });
