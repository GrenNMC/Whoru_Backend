...
namespace WhoruBackend.Migrations
{
    ...
    [Migration("20231213062947_updateChatdb1")]
    partial class updateChatdb1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WhoruBackend.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 12, 13, 6, 29, 46, 828, DateTimeKind.Utc).AddTicks(1749),
                            RoleName = "Admin",
                            UpdatedDate = new DateTime(2023, 12, 13, 6, 29, 46, 828, DateTimeKind.Utc).AddTicks(1755)
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 12, 13, 6, 29, 46, 828, DateTimeKind.Utc).AddTicks(1758),
                            RoleName = "User",
                            UpdatedDate = new DateTime(2023, 12, 13, 6, 29, 46, 828, DateTimeKind.Utc).AddTicks(1760)
                        });
                });
            ...
            modelBuilder.Entity("WhoruBackend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ActiveCode = "412002",
                            CreatedDate = new DateTime(2023, 12, 13, 6, 29, 46, 828, DateTimeKind.Utc).AddTicks(1930),
                            Email = "nmc0401@gmail.com",
                            IsDisabled = false,
                            Password = "AQAQJwAAeUbgIEFsWf5VK1vVSDT8DHECui7N+xONnhuNwHAZMvLDXxKNobfC5hXBOhXGjgOR",
                            Phone = "0769395658",
                            RoleId = 1,
                            UpdatedDate = new DateTime(2023, 12, 13, 6, 29, 46, 828, DateTimeKind.Utc).AddTicks(1932),
                            UserName = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            ActiveCode = "412222",
                            CreatedDate = new DateTime(2023, 12, 13, 6, 29, 46, 863, DateTimeKind.Utc).AddTicks(5428),
                            Email = "20110455@gmail.com",
                            IsDisabled = false,
                            Password = "AQAQJwAAtP4HQmOLW8sAOkyPoUD0yjesaTEfZnjUpTbXMUIaLQNKT3tpwfbxuTJsoZaoSyHs",
                            Phone = "0769395658",
                            RoleId = 1,
                            UpdatedDate = new DateTime(2023, 12, 13, 6, 29, 46, 863, DateTimeKind.Utc).AddTicks(5434),
                            UserName = "admin_2"
                        });
                });
