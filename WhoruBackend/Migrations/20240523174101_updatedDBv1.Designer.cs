...
namespace WhoruBackend.Migrations
{
    ...
    [Migration("20240523174101_updatedDBv1")]
            ...
            modelBuilder.Entity("WhoruBackend.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 5, 23, 17, 41, 0, 828, DateTimeKind.Utc).AddTicks(7412),
                            RoleName = "Admin",
                            UpdatedDate = new DateTime(2024, 5, 23, 17, 41, 0, 828, DateTimeKind.Utc).AddTicks(7417)
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 5, 23, 17, 41, 0, 828, DateTimeKind.Utc).AddTicks(7420),
                            RoleName = "User",
                            UpdatedDate = new DateTime(2024, 5, 23, 17, 41, 0, 828, DateTimeKind.Utc).AddTicks(7421)
                        });
                });
            ...
            modelBuilder.Entity("WhoruBackend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ActiveCode = "412002",
                            CreatedDate = new DateTime(2024, 5, 23, 17, 41, 0, 828, DateTimeKind.Utc).AddTicks(7468),
                            Email = "nmc0401@gmail.com",
                            IsDisabled = false,
                            Password = "AQAQJwAAwt3L/rAir+FNOhG8LrofloPY03Ggm/RWh3hvJurkPc7B36OwaTa7t+kWi4Uc6Gh7",
                            Phone = "0769395658",
                            RoleId = 1,
                            UpdatedDate = new DateTime(2024, 5, 23, 17, 41, 0, 828, DateTimeKind.Utc).AddTicks(7469),
                            UserName = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            ActiveCode = "412222",
                            CreatedDate = new DateTime(2024, 5, 23, 17, 41, 0, 837, DateTimeKind.Utc).AddTicks(8159),
                            Email = "20110455@gmail.com",
                            IsDisabled = false,
                            Password = "AQAQJwAAyD6ZUoxZNz3aAsV33+95QkckppIwX0d3i2mvdEQKW/lwUWv8tklEOHa35rI5GEYm",
                            Phone = "0769395658",
                            RoleId = 1,
                            UpdatedDate = new DateTime(2024, 5, 23, 17, 41, 0, 837, DateTimeKind.Utc).AddTicks(8160),
                            UserName = "admin_2"
                        });
                });
